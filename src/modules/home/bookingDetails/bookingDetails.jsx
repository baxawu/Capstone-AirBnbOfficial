          ...
          <Grid item xs={7}>
            ...
            <div className={style.jss3}>
              <div>
                ...
                <RulaCompo text={'100% of recent guests gave the location a 5-star rating.'} name={'Great location'} icon={<AddLocationAltIcon />} />
                <RulaCompo text={'93% of recent guests rated Amsterdam The Crane By YAYS 5-star in communication.'} name={'Great communication'} icon={<ChatIcon />} />
              </div>
              <div className={style.jss3} >
                {products.moTa}
              </div>
